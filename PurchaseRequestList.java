...
import br.com.firsti.services.websocket.messages.output.filters.FilterOperator;

public class PurchaseRequestList extends AbstractActionList<ModulePurchaseRequest> {

    public PurchaseRequestList() {
        super(new Builder<>(Access.COMPANY_PRIVATE, TableType.LIST, PurchaseRequest.class)
    ...
    public void onWindowRequest(EntityManagerWrapper entityManager, ActionRequest request, WindowBuilder windowBuilder)
        ...
        entityManager
            .createNamedQuery(ProductType.FIND_ALL, ProductType.class)
            .getResultStream()
            .forEach(type ->
                windowBuilder.getPreloadBuilder().addTo("productType", type.getId(), type.getName()));
